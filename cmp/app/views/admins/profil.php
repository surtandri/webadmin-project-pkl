    ...
    <body> 
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php $i=1; foreach ($data['profil'] as $profil);?>
							<div class="col-sm-3">
								<div class="panel panel-primary">
									<div class="panel-heading">
									</div>
									<div class="panel-body">
                    <center><img src="<?php echo URLROOT;?>/public/img/<?php echo $profil->gambar;?>"  alt="#" style="width:200px;border:4px solid #ddd;"/></center>			
									</div>
									<div class="panel-footer">
										<form method="POST" action="<?php echo URLROOT;?>/users/updateFotoProfil/<?php echo $profil->id; ?>" enctype="multipart/form-data">
								...
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<div class="box-content">
											<form class="form-horizontal" method="POST" action="<?php echo URLROOT;?>/admins/updateDataProfil/<?php echo $profil->id; ?>" enctype="multipart/form-data">
												<fieldset>
													<div class="control-group">
														...
														<div class="input-group">
														  <div class="input-group-addon">
															...
															<input required type="text" class="form-control" style="border-radius:0px;" name="nama" id="nama" data-items="4" value="<?php echo $profil->nama_member; ?>" >
														</div>
													</div>
													<div class="control-group">
														...
														<div class="input-group">
														  <div class="input-group-addon">
															...
															<input required type="email" class="form-control" style="border-radius:0px;" name="email" value="<?php echo $profil->email; ?>">
														</div>
													</div>
													<div class="control-group">
														...
														<div class="input-group">
														  <div class="input-group-addon">
															...
															<input required type="text" class="form-control" style="border-radius:0px;" name="telepon" value="<?php echo $profil->telepon; ?>">
														</div>
													</div>
													<div class="control-group">
														...
														<div class="input-group">
														  <div class="input-group-addon">
															...
															<input required type="text" class="form-control" style="border-radius:0px;" name="nik" value="<?php echo $profil->NIK; ?>">
														</div>
													</div>
													<div class="control-group">
														<label class="control-label" for="typeahead">Alamat </label>
														<div class="controls">
															<textarea required name="alamat" rows="3" class="form-control" style="border-radius:0px;"><?php echo $profil->alamat_member; ?></textarea>
														</div>
													</div>
													<br>
													...
													<div class="control-group">
														...
														<div class="input-group">
														  <div class="input-group-addon">
															...
															<input type="text" class="form-control" style="border-radius:0px;" name="user" data-items="4" value="<?php echo $profil->username;?>"/>
														</div>
													</div>
													<div class="control-group">
